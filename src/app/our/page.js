  ...
  <section className="relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <ul className="relative">
          {/* SLIDE 1 */}
          <li className="relative flex items-center justify-center h-screen bg-center bg-cover" style={{ backgroundImage: 'url(/image/hom2-banner1.jpg)' }}>
            <div className="text-center text-white z-10">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                <span className="text-gray-300">Yes We Have</span> <br /> The &nbsp;
                Best &nbsp; Fish &nbsp;<span className="text-yellow-500">Steak</span>
              </h1>
              ...
              <a href="#order-form" className="bg-white text-black px-6 py-3 rounded-full shadow-lg hover:bg-gray-100 transition duration-300 ease-in-out">
                Order Now
              </a>
            </div>
          </li>
          {/* SLIDE 2 */}
          <li className="relative flex items-center justify-center h-screen bg-center bg-cover" style={{ backgroundImage: 'url(/image/hom2-banner2.jpg)' }}>
            <div className="text-center text-white z-10">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                <span className="text-gray-300">Yes We Have</span> <br /> The &nbsp;
                Best &nbsp; Fish &nbsp;<span className="text-yellow-500">Steak</span>
