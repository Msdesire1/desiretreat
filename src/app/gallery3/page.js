        ...
        <div className="zerogrid">
          <div className="wrap-container">
            <div className="wrap-content clearfix">
              <div className="col-2-4 mix work-item drinks heading_space">
              ...
              <div className="col-2-4 mix work-item starters heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    <div className="image">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Spaghetti</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
              ...
              <div className="col-2-4 mix work-item dinner heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    <div className="image">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Crispy Sandwich</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
              ...
              <div className="col-2-4 mix work-item drinks heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Cream Cake</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
              ...
              <div className="col-2-4 mix work-item dinner heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Chocolate Cup Cake</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
              ...
              <div className="col-2-4 mix work-item lunch heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    <div className="image">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Grilled Spice Chicken</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
              ...
              <div className="col-2-4 mix work-item starters heading_space">
                <div className="wrap-col">
                  <div className="item-container">
                    ...
                    <div className="gallery_content">
                      <h3>
                        <a href="recipe_detail.html">Roasted Chicken</a>
                      </h3>
                      <p>Duis autem vel eum iriure dolor</p>
                    </div>
                  </div>
